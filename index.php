<?php
	session_start();
 	...
 	$new_products = executeQuery($sql,true);
 	//lấy ra 12 sản phẩm có lượt view cao
 	$sql='select * from products order by views desc limit 10';
 	$products_view = executeQuery($sql,true);
 	//lấy ra 20 sản phẩm ngẫu nhiên
 	$sql = "SELECT * FROM products order by rand() limit 20";
 	$rand_products = executeQuery($sql,true);
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<?php foreach($new_products as $new_pros): ?>
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img style="width: 70%;" src="<?php echo Base_url.$new_pros['image'] ?>" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="<?php echo Base_url.'detail.php?id='.$new_pros['id']; ?>" class="link-product-add-cart">
													Xem Chi Tiết
												    </a>
												</div>
											</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="<?php echo Base_url.'detail.php?id='.$new_pros['id']; ?>">
													<?php echo $new_pros['name']; ?>
												</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">
													<?php echo $new_pros['price'] ?> VNĐ
												</span>
												<?php if($new_pros['sale_off']==null ||
														$new_pros['sale_off']==''):
												?>
												
												<?php else: ?>
													<del><?php echo $new_pros['sale_off']; ?> VNĐ</del>
												<?php endif; ?>

											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												
												<input pro-id="<?php echo $new_pros['id'] ?>" class=" btn-add2Cart button btn" type="button" value="Add to cart">
						...
						<!-- second section -->
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Các Sản Phẩm Có Lượt Xem Nhiều</h3>
							<div class="row">
							<?php foreach($products_view as $pros_view): ?>
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img style="width: 70%;" src="<?php echo Base_url.$pros_view['image'] ?>" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="<?php echo Base_url.'detail.php?id='.$new_pros['id']; ?>" class="link-product-add-cart">Xem Chi Tiết</a>
												</div>
											</div>
										</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="<?php echo Base_url.'detail.php?id='.$new_pros['id']; ?>"><?php echo $new_pros['name']; ?></a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">
													<?php echo $new_pros['price']; ?> VNĐ
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								...
								<div class="col-md-8 bg-right-nut">
									<img src="<?php echo Base_url ?>public/images/image1.png" alt="">
								</div>
							</div>
						</div>
						<!-- //third section -->
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							<h3 class="heading-tittle text-center font-italic">Các Sản Phẩm Khác</h3>
							<div class="row">
							<?php foreach($rand_products as $rd_pros): ?>
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img style="width: 70%"; src="<?php echo Base_url.$rd_pros['image'] ?>" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="<?php echo Base_url.'detail.php?id='.$rd_pros['id']; ?>" class="link-product-add-cart">
													Xem Chi Tiết 
													</a>
												</div>
											</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="<?php echo Base_url.'detail.php?id='.$rd_pros['id']; ?>"><?php echo $rd_pros['name']; ?></a>
											</h4>
											<div class="info-product-price my-2">
												<?php echo $new_pros['price']; ?> VNĐ
