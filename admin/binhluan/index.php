<?php 
  ...
  $sql = "SELECT *,comments.id as cmtid,products.id as pro_id,users.name as u_name,DATE_FORMAT(comments.created_at,'%d/%m/%Y') AS day_cmt FROM comments JOIN users on comments.user_id=users.id join products on
