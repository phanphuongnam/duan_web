					...
					<ul>
						...
						<li style="width: 280px;" class="nav-item dropdown text-white mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="<?php echo Base_url ?>history.php">
									Lịch Sử Giao Dịch

								</a>
								<a class="dropdown-item" href="<?php echo Base_url ?>thongtin.php">
									Thông Tin Cá Nhân

								</a>
								<a class="dropdown-item" href="<?php echo Base_url ?>changepassword.php">
									Đổi Mật Khẩu
